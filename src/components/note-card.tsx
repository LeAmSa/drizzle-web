...
export function NoteCard({ note }: NoteCardProps) {
  return (
    <Dialog.Root>
      <Dialog.Trigger
        className="flex flex-col rounded-md text-left bg-slate-800 p-5 outline-none 
        gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 
      ...
      <Dialog.Portal>
        ...
        >
          ...
          <button
            type="button"
            className="w-full bg-slate-800 py-4 text-center text-sm text-slate300
             outline-none font-md group"
          >
            Deseja{" "}
